...
const NLU_PROMPT_VERSION = 'nova-nlu-1.3';
...
class RemoteNluInterpreter {
  ...
  async interpret({ tenant, message, state, services, pending }) {
    ...
    const system = [
      ...
      'Extract every field stated in this message: date, time, duration, staff count, quantity, property size, address, name, phone, email, options, and corrections.',
